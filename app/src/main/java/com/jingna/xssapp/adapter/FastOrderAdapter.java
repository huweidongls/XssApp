...
public class FastOrderAdapter extends RecyclerView.Adapter<FastOrderAdapter.ViewHolder> {

    private Context context;
    private List<PayServiceListBean.ObjBean> data;
    private ClickListener listener;

    public FastOrderAdapter(List<PayServiceListBean.ObjBean> data, ClickListener listener) {
        this.data = data;
